        ...
        foreach ($data as $v) {
            if ($pile = self::getPiles($v['id'])) {
                if (isset($result['piles'][$v['id']])) {
                    ...
                    $result['piles'][$v['id']]['lossMoney'] += ($pile['power'] * $pile['availability'] * 24 * $config['yearDay'] * 8 * $pile['electric_loss'] * $config['price'] * $config['tax']) / (1 - $pile['electric_loss']);
                    ...
                    $info['lossMoney'] = ($pile['power'] * $pile['availability'] * 24 * $config['yearDay'] * 8 * $pile['electric_loss'] * $config['price'] * $config['tax']) / (1 - $pile['electric_loss']);
