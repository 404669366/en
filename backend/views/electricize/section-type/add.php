        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="col-sm-4 sgasedfaw">
                    <div class="rule" id="rule1" minTime="0"></div>
                    <div class="form-horizontal cadwad">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">电&emsp;费:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control electrovalence" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">服务费:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control service" value="">
                            </div>
                        </div>
                    </div>
                    <script>
                        ...
                        var lastModel = $("#rule1").ionRangeSlider({
                            skin: "round",
                            grid: true,
                            min: 0,
                            max: 1440,
                ...
                <div class="col-sm-4 sgasedfaw sfesaffw">
                    <span>
                        <button class="fgsfawedfa btn btn-primary" type="button">添加规则</button>
            ...
            <div class="col-sm-4 col-sm-offset-2">
                ...
                <script>
                    ...
                    $('.gki67tyh5').click(function () {
                        ...
                        postCall('/electricize/section-type/add', data);
                    });
                </script>
