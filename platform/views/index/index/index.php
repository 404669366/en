			...
			<div class="main1 box1200 marginTop80">
				...
				<ul class="main1_ul">
					<li>
						...
						<p class="small_tit"><a href="#" class="sm_a">光华逸家·3室1厅·93.89平米</a>
							<span class="price float_right"><a href="#" class="pra">216万</a></span>
						</p>
					</li>
					<li>
						<a href="/index/index/details.html">
				...
				<ul class="main1_ul2">
					<li>
						...
						<div class="resblock-desc">
	                        ...
	                        <span class="ul2_price float_right"><label>13851</label>元/平</span>
                    	</div>
